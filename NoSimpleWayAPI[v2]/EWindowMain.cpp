...
void EDataActionCollection::action_mark_parent_group_as_removed(Entity* _entity, ECustomData* _custom_data, float _d)
{
	...
	if (static_cast<EntityButton*>(_entity)->parent_button_group != nullptr)
	{
		...
		static_cast<EntityButton*>(_entity)->parent_button_group->filter_block_need_remove = true;
...
void EDataActionCollection::action_mark_filter_blocks_as_removed(Entity* _entity, ECustomData* _custom_data, float _d)
{
	...
	else//remove associated buttons from error list
	{
		...
		{
			selected_group->filter_block_need_remove = true;
...
void EDataActionCollection::action_add_new_filter_block(Entity* _entity, ECustomData* _custom_data, float _d)
{
	...
	EWindowMain::loot_filter_editor->group_list[position]->highlight_this_group_green_info();
...
{
	static_cast<EntityButtonForFilterBlock*>(_entity)->parent_filter_block->filter_block_need_remove = true;
...
{
	EWindowMain::make_unsaved_loot_filter_changes();
	static_cast<EntityButtonForListedSegment*>(_entity)->listed_group->filter_block_need_remove = true;
}
		...
		//		BUTTONS FOR PATTERNS
		{
			...
			for (LootSimulatorPattern* loot_pattern : LootSimulatorPattern::registered_loot_simulater_pattern_list)
			{
				...
				(
					...
					((!loot_pattern->is_folder) ? (&EDataActionCollection::action_add_items_from_this_loot_pattern) : (&EDataActionCollection::action_switch_pattern_folder_state)),
					loot_pattern->icon,
...
void EWindowMain::register_filter_rules()
{
	...
	//EUIP
	{
		...
		//filter by game item
		jc_filter = new DataEntityFilter();
		jc_filter->target_tag_name = "name EN";
		jc_filter->suitable_values_list.push_back("Helmets");
		jc_filter->suitable_values_list.push_back("Gloves");
		jc_filter->suitable_values_list.push_back("Boots");

		jc_filter->suitable_values_list.push_back("Body Armour");

		jc_filter->suitable_values_list.push_back("Two Hand Axes");
		jc_filter->suitable_values_list.push_back("Two Hand Swords");
		jc_filter->suitable_values_list.push_back("Two Hand Maces");

		jc_filter->suitable_values_list.push_back("Staves");
		jc_filter->suitable_values_list.push_back("Warstaves");

		jc_filter->suitable_values_list.push_back("Daggers");
		jc_filter->suitable_values_list.push_back("Rune Daggers");

		jc_filter->suitable_values_list.push_back("One Hand Maces");
		jc_filter->suitable_values_list.push_back("One Hand Axes");
		jc_filter->suitable_values_list.push_back("One Hand Swords");
		jc_filter->suitable_values_list.push_back("Claws");
		jc_filter->suitable_values_list.push_back("Wands");

		jc_filter->suitable_values_list.push_back("Bows");
		jc_filter->suitable_values_list.push_back("Quivers");

		jc_filter->suitable_values_list.push_back("Shields");

		jc_filter->suitable_values_list.push_back("Rings");
		jc_filter->suitable_values_list.push_back("Amulets");
		jc_filter->suitable_values_list.push_back("Belts");

		jc_filter->suitable_values_list.push_back("Fishing Rods");
		jc_filter_rule->required_tag_list.push_back(jc_filter);
		//
	...
	//UNIQUES valuable
	{
		...
		jc_filter = new DataEntityFilter();
		jc_filter->target_tag_name = "item tag";
		jc_filter->suitable_values_list.push_back("Good base for unique");
		jc_filter_rule->required_tag_list.push_back(jc_filter);
		//
	...
	//UNIQUES valuable
	{
		...
		jc_filter = new DataEntityFilter();
		jc_filter->target_tag_name = "item tag";
		jc_filter->suitable_values_list.push_back("Expensive base for unique");
		jc_filter_rule->required_tag_list.push_back(jc_filter);
		//
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	button_variant_router->add_default_description_by_key("description_show_hide_loot");
	//
	...
	for (int i = 0; i < 5; i++)
	{
		...
		button_variant_router->action_on_choose_variant_from_window.push_back(&EDataActionCollection::action_make_unsave_filter_block_changes_and_refresh_loot_simulator);
		...
		button_variant_router->add_default_description_by_key("description_loot_version_control");
...
////////////////
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
		...
		non_list_condition_group->add_default_clickable_region_with_text_area(ELocalisationText::get_localisation_by_key("text_region_press_plus_button_to_add_new_condition"));
...
/*			SECONDARY COSMETIC SEGMENT BUTTONS [sounds, ray, minimap icon]			*/
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
		...
		sound_cosmetic_segment->add_button_to_working_group(button_variant_disable_sound);
		...
		button_variant_disable_sound->can_be_stretched = true;
	...
	sound_cosmetic_segment->add_button_to_working_group(sound_button);
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	sound_cosmetic_segment->add_button_to_working_group(button_custom_sound_bool_suppressor);
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	sound_cosmetic_segment->add_button_to_working_group(button_variant_FB_router);
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	sound_button->main_text_area->localisation_text = l_text;
	//sound_button->force_field_up = 8.0f;
	sound_button->can_be_stretched = true;
	...
	sound_cosmetic_segment->add_button_to_working_group(button_ingame_sound_suppressor_bool);
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//	VOLUME
	{
		...
		sound_cosmetic_segment->add_button_to_working_group(jc_button);
	}
					...
					if (data_part == DataOrderNames::ATTRIBUTE)
					{
						...
						)
						{
							...
							if (!comment_mode)
							{
								...
								{
									((EntityButtonVariantRouter*)(whole_filter_block->button_show_hide))->select_variant(1);
								}
								else
								{
									((EntityButtonVariantRouter*)(whole_filter_block->button_show_hide))->select_variant(0);
								}
							}
							else
							{
						...
						else
						{
								...
								)
							{
								...
								////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								if (matched_item_attribute->filter_attribute_type == FilterAttributeType::FILTER_ATTRIBUTE_TYPE_NON_LISTED)
								{
									if
										(
											(jc_filter_block != nullptr)
								...
								if (matched_item_attribute->filter_attribute_type == FilterAttributeType::FILTER_ATTRIBUTE_TYPE_COSMETIC)
								{
									if (whole_filter_block != nullptr)
									{
										for (int b = 0; b < 3; b++)
										{
											if (whole_filter_block->pointer_to_color_button[b]->main_text_area->localisation_text.base_name == matched_item_attribute->localisation.base_name)
											{
												//matched_button = whole_block_container->pointer_to_color_button[b];
												target_HRA_color = whole_filter_block->pointer_to_color_button[b]->stored_color;
												target_color_bool = &whole_filter_block->color_check[b];
											}
										}

										if ((matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_MINIMAP_ICON) && (!comment_mode))
										{
											whole_filter_block->minimap_icon_color_suppressor_bool = true;
										}
									}

									if ((matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_VALUE_USER_SOUND) && (!comment_mode))
									{
									...
									if ((!comment_mode) && (whole_filter_block != nullptr))
									{
										//disable/enable varian router button
										int disable_sound_router_id = -1;
										disable_sound_router_id = whole_filter_block->pointer_to_disable_enable_drop_sound->seach_id_by_base_name(matched_item_attribute->localisation.base_name);
										if (disable_sound_router_id >= 0) { whole_filter_block->pointer_to_disable_enable_drop_sound->select_variant(disable_sound_router_id); }

										if (matched_item_attribute->localisation.base_name == "PlayAlertSoundPositional")
										{
											whole_filter_block->pointer_to_positional_variant_button->select_variant(1);
										}
										else
											if (matched_item_attribute->localisation.base_name == "PlayAlertSound")
											{
												whole_filter_block->pointer_to_positional_variant_button->select_variant(0);
											}
											else
												if (matched_item_attribute->localisation.base_name == "CustomAlertSoundOptional")
												{
													whole_filter_block->pointer_to_optional_user_sound->select_variant(1);
												}
									}
									...
									if (whole_filter_block != nullptr)
									{
										...
										{
											whole_filter_block->ray_suppressor = true;
										}

										if ((matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_CONTINUE) && (!comment_mode))
										{
											whole_filter_block->button_continue->select_variant(0);
										}
									}
					...
					if (data_part >= DataOrderNames::VALUE)
					{
						...
						if (matched_item_attribute != nullptr)
						{
							...
							if (matched_item_attribute->filter_attribute_type == FilterAttributeType::FILTER_ATTRIBUTE_TYPE_COSMETIC)
							{
								...
								if ((matched_item_attribute->localisation.base_name == "SetFontSize") && (whole_filter_block != nullptr))
								{

									whole_filter_block->text_size = (std::stoi(buffer_text) - 18) / 27.0f;

									whole_filter_block->text_size = max(whole_filter_block->text_size, 0.0f);
									whole_filter_block->text_size = min(whole_filter_block->text_size, 1.0f);

									whole_filter_block->text_size_bool = true;
									//d_container->
								}
								...
								//		MINIMAP ICON
								if ((matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_MINIMAP_ICON) && (whole_filter_block != nullptr))
								{
									EntityButtonVariantRouter* router_button_size = whole_filter_block->pointer_to_minimap_icon_size_router;
									EntityButtonVariantRouter* router_button_color = whole_filter_block->pointer_to_minimap_icon_color_router;
									EntityButtonVariantRouter* router_button_shape = whole_filter_block->pointer_to_minimap_icon_shape_router;
									...
									if (data_part == 2)
									{
										...
										{
											whole_filter_block->pointer_to_forcibly_disable_minimap_icon_variant_button->select_variant(1);
										}
									}
								...
								if (matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_VALUE_USER_SOUND)
								{
									...
									if (data_part == 2)
									{
										...
										if (whole_filter_block != nullptr)
										{
											whole_filter_block->pointer_to_custom_sound_button->stored_named_sound = matched_named_sound;
											if (!comment_mode) { whole_filter_block->custom_sound_suppressor_bool = true; }
										}
									}
								}
								...
								if (matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_VALUE_INGAME_SOUND)
								{
									if (data_part == 2)
									{
										...
										if (buffer_text != "none")
										{
											...
											if (whole_filter_block != nullptr)
											{
												whole_filter_block->pointer_to_game_sound_button->stored_named_sound = matched_named_sound;
												if (!comment_mode) { whole_filter_block->game_sound_suppressor_bool = true; }

												whole_filter_block->pointer_to_forcibly_disable_sound_variant_button->select_variant(0);
											}
										...
										{
											if (!comment_mode)
											{whole_filter_block->pointer_to_forcibly_disable_sound_variant_button->select_variant(1);}
											else
											{whole_filter_block->pointer_to_forcibly_disable_sound_variant_button->select_variant(0);}
										}
										...
										if ((data_part == 3) && (whole_filter_block != nullptr))
										{
											float
											...
											whole_filter_block->sound_volume_value = value;
										}
								...
								//		RAY
								if ((matched_item_attribute->filter_attribute_value_type == FILTER_ATTRIBUTE_VALUE_TYPE_RAY) && (!comment_mode) && (whole_filter_block != nullptr))
								{
									EntityButtonVariantRouter* ray_router = whole_filter_block->pointer_to_ray_color_router;
									...
									{
										whole_filter_block->pointer_to_temporary_option_router->select_variant(1);
									}
								}
								...
								switch (matched_item_attribute->filter_attribute_value_type)
								{
									case FilterAttributeValueType::FILTER_ATTRIBUTE_VALUE_CONFIG_VERSIONS:
									{
										if (whole_filter_block != nullptr)
										{
											...
											EntityButtonVariantRouterForFilterBlock*
												target_router = whole_filter_block->version_routers[router_id];
...
void EWindowMain::add_force_field_for_last_pattern_folder()
{
...
void EWindowMain::register_pattern_folder(std::string _localisation_key, std::string _icon_path)
{
	...
	loot_simulator_pattern->localised_name = ELocalisationText::get_localisation_by_key(_localisation_key);

	loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder(_icon_path);
	loot_simulator_pattern->is_folder = true;
...
void EWindowMain::register_loot_simulator_patterns()
{
	...
	register_new_folder_uniques();
		add_force_field_for_last_pattern_folder();

	register_new_folder_breach_items();
	register_new_folder_delve_items();
	register_new_folder_heist_items();
		add_force_field_for_last_pattern_folder();
	
	register_new_folder_map_items();
		add_force_field_for_last_pattern_folder();

	register_new_folder_specific_items();
		add_force_field_for_last_pattern_folder();
	...
	register_pattern_folder_divinations();
		add_force_field_for_last_pattern_folder();
	...
	register_new_folder_boss_loot();
		add_force_field_for_last_pattern_folder();

	register_new_folder_gems();
		add_force_field_for_last_pattern_folder();

}

void EWindowMain::register_new_folder_gems()
{
	//		GEMS
	{
		LootSimulatorPattern*
...
void EWindowMain::register_new_folder_map_items()
{
	...
	register_pattern_reliquary_keys();
...
void EWindowMain::register_pattern_reliquary_keys()
{
	//		SET FRAGMENTS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Ключи реликвария";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/OublietteReliquaryKey");
...
void EWindowMain::register_new_folder_delve_items()
{
	//		DELVE ITEMS: FOSSILS
	{
		LootSimulatorPattern*
		...
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Faceted_Fossil_inventory_icon");
		...
		/////////////////////////////			ITEM GENERATOR (DELVE ITEM)			/////////////////////////////////////////////
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Delve fossil");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//		DELVE ITEMS: RESONATORS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Delve items:\\nResonators";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Предметы шахты:\\nРезонаторы";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Powerful_Chaotic_Resonator_inventory_icon");
		...
		/////////////////////////////			ITEM GENERATOR (DELVE ITEM)			/////////////////////////////////////////////
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Delve resonator");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//		DELVE ITEMS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Delve items:\\nSpecial explicits";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Предметы шахты:\\nОсобые свойства";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Cabalist_Regalia_inventory_icon");
...
void EWindowMain::register_new_folder_breach_items()
{
	//		BREACH
	{
		...
		/////////////////////////////			ITEM GENERATOR(Breach fragments)			/////////////////////////////////////////////
		{
			...
			loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Xoph's_Breachstone");
		...
		/////////////////////////////			ITEM GENERATOR(Breach blessings)			/////////////////////////////////////////////
		{
			...
			loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Blessing_of_Uul-Netol_inventory_icon");
		...
		/////////////////////////////			ITEM GENERATOR(Uniques)			/////////////////////////////////////////////
		{
			...
			loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("buttons/breach_uniques");
...
void EWindowMain::register_new_folder_uniques()
{
	...
	//UNIQUES LEVELING
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Уникальные предметы для старта";
...

		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Unique item");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
			...
			tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Good for start");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
...
void EWindowMain::register_pattern_runic_base()
{
	//RUNIC ITEMS
	{
		LootSimulatorPattern*
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Runic items";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Рунические предметы";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/RunicHelmet");
		...
		loot_simulator_pattern->additional_force_field_for_buttons = true;
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Runic base");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
...
void EWindowMain::register_new_folder_heist_items()
{
	//HEIST BASES
	{
		LootSimulatorPattern*
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist base items";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Базы кражи";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/SuperFangs");
		...
		//3 LINKS
		{
			...
			tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Heist base");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//HEIST TOOLS
	{
		...
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Cloak");
	...
	//HEIST TARGETS (LOW)
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist targets (Low value)";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Цель кражи (Низкая ценность)";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HeistTarget");
		...
		//
		{
			...
			tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Heist Target: Low value");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//HEIST TARGETS (MODERATE)
	{
		LootSimulatorPattern*
			loot_simulator_pattern = new LootSimulatorPattern;

		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist targets (Moderate value)";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Цель кражи (Средняя ценность)";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HeistTarget");
		...
		//
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Heist Target: Moderate value");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//HEIST TARGETS (HIGH)
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist targets (High value)";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Цель кражи (Ценная)";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HeistTarget");
		...
		//
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Heist Target: High value");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//HEIST TARGETS (Precious)
	{
		LootSimulatorPattern*
			loot_simulator_pattern = new LootSimulatorPattern;

		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist targets (Precious)";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Цель кражи (Дорогая)";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HeistTarget");
		...
		//
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Heist Target: Precious");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//HEIST TARGETS (Priceless)
	{
		LootSimulatorPattern*
			loot_simulator_pattern = new LootSimulatorPattern;

		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist targets (Priceless)";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Цель кражи (Наивысшая ценность)";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HeistTarget");
		...
		//
		{
			...
			LootSimulatorTagFilter*
				tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Heist Target: Priceless");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
	...
	//HEIST QUEST CONTRACTS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Контракт кражи (квест)";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HeistQuestContract");
	...
	//HEIST CONTRACTS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist сontract";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Контракт кражи";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Contract");
	...
	//HEIST BLUEPRINTS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Heist blueprints";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Чертежи кражи";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Blueprint");
...
void EWindowMain::register_pattern_all_equip()
{
	//		ALL EQUIP (low level)
	{
		...
		/////////////////////////////			ITEM GENERATOR (ALL GLOVES, HELMETS, BOOTS)			/////////////////////////////////////////////
		{
			GameItemGenerator*
				game_item_generator = new GameItemGenerator();
			loot_simulator_pattern->game_item_generator_list.push_back(game_item_generator);
...
{
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Expedition currency";
		...
		/////////////////////////////			ITEM GENERATOR (EXPEDITION CURRENCY)			/////////////////////////////////////////////
		{
			...
			tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Expedition currency");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
...
void EWindowMain::register_pattern_oils_and_catalysts()
{
	//		OILS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Oils";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Масла";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/Teal_Oil");
	...
	//		CATALYSTS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Catalysts";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Катализаторы";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/unstable_catalyst");
...
void EWindowMain::register_embers_and_ichors()
{
	//		EMBERS AND ICHORS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Ambers and ichors";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Угольки и ихоры";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("buttons/EmbersAndIchors");


		/////////////////////////////			ITEM GENERATOR (AMBERS AND ICHORS)			/////////////////////////////////////////////
		{
			GameItemGenerator*
				game_item_generator = new GameItemGenerator();
			game_item_generator->generations_count = 1;
			...
			tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Ember item");
			tag_filter->suitable_values.push_back("Ichor item");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
...
void EWindowMain::register_pattern_guardian_orbs()
{
	//		GUARDIAN ORBS
	{
		...
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_EN] = "Guardian orbs";
		loot_simulator_pattern->localised_name.localisations[NSW_localisation_RU] = "Сферы Хранителей";
		loot_simulator_pattern->icon = NS_EGraphicCore::load_from_textures_folder("icons/HunterExalt");
		...
		/////////////////////////////			ITEM GENERATOR (AMBERS AND ICHORS)			/////////////////////////////////////////////
		{
			...
			tag_filter = new LootSimulatorTagFilter;
			tag_filter->target_tag = "item tag";
			tag_filter->suitable_values.push_back("Guardian orb");
			game_item_generator->filtered_by_tags.push_back(tag_filter);
...
void EWindowMain::register_new_folder_crucible_items()
{
...
void EWindowMain::register_new_folder_basic_currency()
{
...
EButtonGroup* create_block_for_listed_segment(EFilterRule* _filter_rule, GameItemAttribute* _attribute, std::string _attribute_name, EButtonGroup* _parent)
{
	...
	{
		whole_listed_line->min_size_y = 80.0f;
	}
	...
	else
	{
		...
		add_new_undefined_attribute_button->parent_filter_block = static_cast<EButtonGroupFilterBlock*>(_parent);
	...
	for (int i = 0; i < 50; i++)
		if (data_entity_id < EDataEntity::data_entity_global_list.size())
		{
			...
			if (data_entity_id >= EDataEntity::data_entity_global_list.size())
			{
				...
				EWindowMain::background_loading_info->filter_block_need_remove = true;
...
void GameItemGenerator::init_game_item(EGameItem* _game_item)
{
	...
	)
	{
		...
		if (DataEntityUtils::get_tag_value_by_name(0, "base ward min", _game_item->stored_data_entity) != "")
		{
			EGameItemAttributeContainer
				game_item_attribute_container;
			...
			int min_ward = EStringUtils::safe_convert_string_to_number(DataEntityUtils::get_tag_value_by_name(0, "base ward min", _game_item->stored_data_entity), 0, 99999);
			int max_ward = EStringUtils::safe_convert_string_to_number(DataEntityUtils::get_tag_value_by_name(0, "base ward max", _game_item->stored_data_entity), 0, 99999);
...
void EntityButtonLootItem::get_matched_filter_blocks_list(EButtonGroupFilterBlockEditor* _filter_block_editor)
{
	...
	if
	(
		(!group->filter_block_need_remove)
		&&
