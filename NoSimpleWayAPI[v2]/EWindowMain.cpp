...
EWindowMain::EWindowMain()
{
	...
	*jc_entity->world_position_y = 40.0f;
	...
	NS_ERenderCollection::subdivision_x = 3.0f;
	NS_ERenderCollection::subdivision_y = 3.0f;
	...
	main_button_group = new EButtonGroup();
		...
		jc_region_gabarite = new ERegionGabarite(64.0f, 64.0f, 1200.0f, 800.0f);
		...
		for (int z = 0; z < 10; z++)
		{
			...
			jc_region_gabarite = new ERegionGabarite(10.0f, 5.0f, 1200.0f, 160.0f); jc_button_group_row->gabarite = jc_region_gabarite;
			...
			jc_region_gabarite = new ERegionGabarite(10.0f, 5.0f, 100.0f, 150.0f); jc_button_group->region = jc_region_gabarite;
			...
			for (int k = 0; k < 1; k++)
			{
				...
				jc_button_group = new EButtonGroup(); jc_button_group_row->button_group_list.push_back(jc_button_group);
				jc_region_gabarite = new ERegionGabarite(5.0f, 5.0f, 600.0f, 150.0f); jc_button_group->region = jc_region_gabarite;
				jc_button_group->parent_group_row = jc_button_group_row;
