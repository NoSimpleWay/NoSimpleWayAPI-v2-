...
public:
	...
	bool is_autosaved_loot_filter		= false;

	PathOfExileGame game_version		= PathOfExileGame::POE1;
...
public:
	...
	PathOfExileGame
	game_version = PathOfExileGame::POE1;
};
...
class EntityButtonGameAttribute : public EntityButton
{
public:
	//PathOfExileGame
	//game_type = PathOfExileGame::BOTH;
...
public:
	...
	EntityButtonVariantRouter* pointer_to_game_version_router;

	void show_only_suitable_buttons_for_filter_list();
};
...
public:
	...
	static EButtonGroup* pointer_to_game_version_segment;
...
namespace EDataActionCollection
{
	...
	void add_wide_item_button_to_listed_group(EButtonGroup* receiver, Entity* _entity, EDataContainer_DataEntityHolder* data_entity_holder);
	...
	void action_open_confirm_decline_window_for_autosaved_loot_filter(Entity* _entity, ECustomData* _custom_data, float _d);
	void action_confirm_open_autogenerated_loot_filter(Entity* _entity, ECustomData* _custom_data, float _d);
	void action_confirm_open_autosave_loot_filter(Entity* _entity, ECustomData* _custom_data, float _d);
...
public:
	...
	PathOfExileGame						game_type = PathOfExileGame::BOTH;
...
public:
	...
	static EButtonGroupConfirmActionOpenAutogeneratedLootFilter* confirm_load_autosaved_block;
	...
	{
		LLFLM_PATH_OF_EXILE_FOLDER,
		LLFLM_AUTOSAVE_FOLDER
	};


	static void										add_this_loot_filter_to_list(const std::experimental::filesystem::v1::directory_entry& p, EButtonGroup* part_with_list, LoadLootFilterListMode _mode, PathOfExileGame _game_version);
