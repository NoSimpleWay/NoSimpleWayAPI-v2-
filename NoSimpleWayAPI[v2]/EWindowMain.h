...
public:
	...
	static void										add_this_loot_filter_to_list(const std::experimental::filesystem::v1::directory_entry& p, EButtonGroup* part_with_list, LoadLootFilterListMode _mode);
