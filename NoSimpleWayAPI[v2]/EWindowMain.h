...
namespace EDataActionCollection
{
	...
	void action_make_unsave_filter_block_changes_and_refresh_loot_simualator(Entity* _entity, ECustomData* _custom_data, float _d);
...
static void add_game_item_attribute_to_filter_block(EButtonGroupFilterBlock* _target_group, GameItemAttribute* _filter_block_attribute);
