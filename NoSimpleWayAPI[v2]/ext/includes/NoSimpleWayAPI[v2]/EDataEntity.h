...
namespace DataEntityUtils
{
	...
	extern std::string	get_tag_value_by_name_ID		(int _id, const ID_string* _name,	EDataEntity* _data_entity);

	extern ID_string*	get_tag_ID_string_by_name_ID	(int _id, const ID_string* _name,	EDataEntity* _data_entity);

	extern void set_tag_value_by_name					(int _id, std::string _name,		std::string _value,				EDataEntity* _data_entity);
	extern void set_tag_value_by_ID_string_name			(int _id, const ID_string* _name,	std::string _value,				EDataEntity* _data_entity);


	extern bool is_exist_tag_by_name_and_value			(int _id, std::string _name,		std::string _value,				EDataEntity* _data_entity);
	extern bool is_exist_tag_by_name_and_value_ID		(int _id, const ID_string* _name,	const ID_string* _value,		EDataEntity* _data_entity);
	extern bool is_exist_tag_by_name_and_value_ID		(int _id, const ID_string* _name,	std::string _value,				EDataEntity* _data_entity);
}
