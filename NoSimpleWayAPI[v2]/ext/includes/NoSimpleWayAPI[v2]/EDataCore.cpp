...
namespace ERegisteredStrings
{
	...
	const ID_string ERegisteredStrings::cost_in_chaoses_world_drop		= ID_string::register_new_unique_ID_by_key("Cost in chaoses world base");
	const ID_string ERegisteredStrings::cost_in_chaoses_non_world_drop	= ID_string::register_new_unique_ID_by_key("Cost in chaoses non-world base");
	const ID_string ERegisteredStrings::cost_in_chaoses					= ID_string::register_new_unique_ID_by_key("cost in chaoses");
